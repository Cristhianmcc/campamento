          ...
          <div className="space-y-6">
              ...
              <div className="flex gap-3">
                ...
                <div className="text-sm text-gray-700">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>Haz clic en el botón de abajo para enviar tu captura</li>
                    <li>El mensaje incluirá tu código de inscripción</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              >
                ...
                <span className="text-sm sm:text-base">Enviar captura por WhatsApp</span>
              </Button>
            </div>
          </div>
        ) : (
